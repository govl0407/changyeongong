...
#define _SERVO_SPEED 560 // servo speed limit (unit: degree/second)
...
// convert angle speed into duty change per interval.
  duty_chg_per_interval = ((float)_DUTY_MAX - (float)_DUTY_MIN) * ((float)_SERVO_SPEED / 180) * ((float)INTERVAL / 1000);
